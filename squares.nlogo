...
to test
  ...
  ca
  reset-ticks
  let s blueSquares._init_ 4;
  let speed 0;
  let maxSpeed 6;

  ; Go ahead!
  sound:play-note "TRUMPET" 60 64 0.2;
  wait 0.1;
  sound:play-note "TRUMPET" 64 64 0.2;
  wait 0.1;
  sound:play-note "TRUMPET" 67 64 0.1;
  wait 0.1;
  ...
  while [speed != maxSpeed] [
    cd
    set speed (min (list (speed + 0.1) maxSpeed));
    objects.move s speed 0;
    every 0.5 [
      sound:play-drum "Hand Clap" 64;
    ]
    squares.addSize s 0.1;
    objects.rot s 10;
    squares.draw s;
    tick;
  ]
  ...
  while [speed != 0] [
    cd
    set speed (max (list (speed - 0.1) 0));
    objects.move s speed 0;
    every 0.5 [
      sound:play-drum "Hand Clap" 64;
    ]
